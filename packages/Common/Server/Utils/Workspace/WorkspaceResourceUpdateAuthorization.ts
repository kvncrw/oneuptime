...
/*
 * Resource state actions update the parent row as well as creating a timeline.
 * This guard applies the same update and privacy scopes as the CRUD API after
 * WorkspaceActionAuthorization has checked the mutation model's create
 * permission and the actor's read access to the resource.
 */
export default class WorkspaceResourceUpdateAuthorization {
  @CaptureSpan()
